    ...
    public static int largestRectangleArea(int[] heights) {
        ...
        for (int index = 1; index < heights.length; index++) {
            ...
            if (heights[index] < validRectangles.peek().height) {
                ...
                int area = rect.height * (index - 1 - rect.indexStart);
                ...
                validRectangles.push(new Rectangle(rect.indexStart, heights[index]));
            }
        }
        ...
        while (!validRectangles.isEmpty()) {
            Rectangle rect = validRectangles.pop();
            int area = rect.height * (heights.length - 2 - rect.indexStart);
            if (area > largestArea) {
                largestArea = area;
            }
        }
